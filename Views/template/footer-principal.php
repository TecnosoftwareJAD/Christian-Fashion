...
<div class="copyright_section">
            ...
            <div class="container__footer">
                ...
                <div class="box__footer">
                    <div class="footer_logo">
                        <img src="<?php echo BASE_URL; ?>assets/images/logo1.png" class="img-fluid" alt="main_logo">
                    </div>
                    <div class="terms">
                        <p>Somos una tienda de ropa cristiana comprometida con ofrecerte prendas de calidad que reflejen
                            tu fe y valores.</p>
                    </div>
                    <!-- Nueva fila agregada -->
                    <div class="terms">
                ...
                <div class="box__footer">
                    ...
                    <ul class="footer_menu">
                        <li><a href="http://localhost/Almacen_online1/#categoria_6">Faldas</a></li>
                        <li><a href="http://localhost/Almacen_online1/#categoria_7">Pantalones</a></li>
                        <li><a href="http://localhost/Almacen_online1/#categoria_8">Vestidos</a></li>
                        <li><a href="http://localhost/Almacen_online1/#categoria_10">Accesorios</a></li>
                        <!-- Nueva fila agregada -->
                        <li><a href="http://localhost/Almacen_online1/#categoria_9">Blusas</a></li>
                    </ul>
                </div>
                ...
                <div class="box__footer">
                    ...
                    <ul class="footer_menu">
                        <li><a href="https://www.facebook.com" target="_blank"><i class="fab fa-facebook-square"></i>
                                Facebook</a></li>
                        <li><a href="https://www.instagram.com" target="_blank"><i class="fab fa-instagram-square"></i>
                                Instagram</a></li>
                        <li><a href="https://wa.me/573217106095?Hola%20Quiero%20Saber%20mas%20informacion"
                                target="_blank">
                                <i class="fab fa-whatsapp"></i> WhatsApp</a></li>
                        <li><a href="tecnosoftware1ad@gmail.com" target="_blank"><i class="fas fa-envelope"></i>
                                Gmail</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="copyright_section">
                <div class="container">
                    <p class="copyright_text">
                        Todos los derechos reservados © <?php echo date('Y'); ?> <b>CHRISTIAN FASHION</b>
                    </p>
                </div>
            </div>
        </div>
    ...
    <div id="modalLogin" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title"
        aria-hidden="true">
                ...
                <div class="modal-body m-3">
                    <div class="text-center">
                        <img class="img-thumbnail rounded-circle"
                            src="<?php echo BASE_URL . 'assets/images/logo1.png'; ?>" alt="" width="70">
                    </div>
                    <div class="row">

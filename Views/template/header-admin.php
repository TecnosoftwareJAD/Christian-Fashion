    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="<?php echo BASE_URL; ?>" target="_blank">
                <img src="<?php echo BASE_URL; ?>assets/images/logo1.png" class="navbar-brand-img h-100"
                    alt="main_logo">
                <span class="ms-1 font-weight-bold text-white">Christian Fashion</span>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($data['title'] == 'administracion') ? 'active bg-gradient-primary' : ''; ?>"
                ...
                <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($data['title'] == 'usuarios') ? 'active bg-gradient-primary' : ''; ?>"
                ...
                <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($data['title'] == 'categorias') ? 'active bg-gradient-primary' : ''; ?>"
                ...
                <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($data['title'] == 'productos') ? 'active bg-gradient-primary' : ''; ?>"
                ...
                <li class="nav-item">
                    <a class="nav-link text-white <?php echo ($data['title'] == 'pedidos') ? 'active bg-gradient-primary' : ''; ?>"
                                ...
                                <li class="mb-2">
                                    <a class="dropdown-item border-radius-md" href="javascript:;">
                                        <div class="d-flex py-1">
                                            <div class="my-auto">
                                                <img src="<?php echo BASE_URL; ?>assets/admin/img/team-2.jpg"

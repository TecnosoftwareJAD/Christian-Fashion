...
<head>
    ...
    <!-- fevicon -->
    <link rel="icon" href="<?php echo BASE_URL; ?>assets/images/logo1.png" type="image/gif" />
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="custom_menu">
                            <ul>
                                <li><a href="">CHRISTIAN FASHION</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="logo"><a href="<?php echo BASE_URL; ?>"><img
                                    src="<?php echo BASE_URL; ?>assets/images/logo1.png" width="50"></a></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="containt_main">
                    ...
                    <span class="toggle_icon" onclick="openNav()"><img
                            src="<?php echo BASE_URL; ?>assets/principal/images/toggle-icon.png"></span>
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item"
                                href="#categoria_<?php echo $categoria['id']; ?>"><?php echo $categoria['categoria']; ?></a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="main">
